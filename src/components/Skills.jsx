          ...
          >
            {skill.map((talent, index) => (
              <SwiperSlide key={index} className="overflow-visible">
                {" "}
                <div className="flex flex-col items-center justify-center border border-[#068e79] shadow-md hover:shadow-[0_0_15px_#068e79] p-6 my-6 rounded-2xl hover:scale-105 transition-transform duration-300 w-60 h-60 mx-auto text-center">
